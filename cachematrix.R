...
##This R function is able to cache potentially time-consuming computations. Matrix inversion is
##usually a costly computation and thus athis function is written to cache the inverse of the
##matrix rather than computing it repeatedly.


## Write a short comment describing this function

##The first function, makeCacheMatrix creates a special "matrix", which is really a dataframe containing a function to
